...
export default function DocumentRenderer({ filename, data }: Props) {
  ...
  return (
    <div className="p-10 max-w-3xl mx-auto">
      <div className="mb-6 px-4 py-3 rounded-lg border border-yellow-200 bg-yellow-50 text-xs text-yellow-800 leading-relaxed">
        <strong>Draft document.</strong> This document is a draft generated by AI and should be reviewed by a qualified legal professional before use.
      </div>
      <ReactMarkdown
